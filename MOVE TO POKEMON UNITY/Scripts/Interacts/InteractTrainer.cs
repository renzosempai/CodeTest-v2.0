        ...
        //            BgmHandler.main.PlayOverlay(Scene.main.Battle.defaultTrainerBGM,
         ...
         //       }
           ...
           //     yield return new WaitForSeconds(1.6f);
			...
			//	Scene.main.Multiple.gameObject.SetActive(true);
			//	Cursor.visible = true;
				//Scene.main.GameCon.gameObject.SetActive(true);
			
				//yield return new WaitForSeconds(1.6f);
			

				//	while (Scene.main.GameCon.gameObject.activeSelf)
             //  {
            //      yield return null;
            //   }
			
				SceneManager.LoadScene ("Text Quiz/Scene/Text Quiz",LoadSceneMode.Single);
