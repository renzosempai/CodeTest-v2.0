...
public class LevelCavewithLightsMultipleChoice : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevelCavewithLightsMultipleChoice;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Chuck").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Chuck").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevelCavewithLightsMultipleChoice.SetActive (false);
