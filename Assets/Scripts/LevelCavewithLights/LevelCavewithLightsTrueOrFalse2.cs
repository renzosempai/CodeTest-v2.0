...
public class LevelCavewithLightsTrueOrFalse2 : MonoBehaviour {

	List<string> questions = new List<string> () {" "};
	List<string> correctAnswer = new List<string>() {" "};
	public GameObject CallLevelCavewithLightsTrueOrFalse2;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Kyle").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Kyle").GetComponent<InteractTrainer> ().busy = false;
	/* 	StartCoroutine(BacktoWorld()); */
		CallLevelCavewithLightsTrueOrFalse2.SetActive (false);
