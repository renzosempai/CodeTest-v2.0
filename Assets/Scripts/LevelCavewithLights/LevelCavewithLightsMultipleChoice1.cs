...
public class LevelCavewithLightsMultipleChoice1 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevelCavewithLightsMultipleChoice1;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Ophelia").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Ophelia").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevelCavewithLightsMultipleChoice1.SetActive (false);
