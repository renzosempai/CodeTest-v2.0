...
public class LevelCavewithLightsTrueOrFalse : MonoBehaviour {

	List<string> questions = new List<string> () {" "};
	List<string> correctAnswer = new List<string>() {" "};
	public GameObject CallLevelCavewithLightsTrueOrFalse;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Yesenia").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Yesenia").GetComponent<InteractTrainer> ().busy = false;
	/* 	StartCoroutine(BacktoWorld()); */
		CallLevelCavewithLightsTrueOrFalse.SetActive (false);
