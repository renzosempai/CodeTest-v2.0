...
public class LevelCavewithLightsMultipleChoice6 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevelCavewithLightsMultipleChoice6;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Elsie").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Elsie").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevelCavewithLightsMultipleChoice6.SetActive (false);
