...
public class LevelCavewithLightsMultipleChoice2 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevelCavewithLightsMultipleChoice2;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Wilbert").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Wilbert").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevelCavewithLightsMultipleChoice2.SetActive (false);
