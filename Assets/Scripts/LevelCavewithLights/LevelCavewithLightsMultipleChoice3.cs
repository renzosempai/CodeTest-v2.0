...
public class LevelCavewithLightsMultipleChoice3 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevelCavewithLightsMultipleChoice3;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Lyle").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Lyle").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevelCavewithLightsMultipleChoice3.SetActive (false);
