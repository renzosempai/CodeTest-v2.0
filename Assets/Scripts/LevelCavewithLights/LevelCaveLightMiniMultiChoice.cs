...
public class LevelCaveLightMiniMultiChoice : MonoBehaviour {
...
//		}
	...
	public void Answer(){
		...
		LevelCaveLightMiniMulti.selectedAnswer = gameObject.name;
		LevelCaveLightMiniMulti.choiceSelected = "y";
	}
