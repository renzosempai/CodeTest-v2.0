...
public class LevelCavewithLightsMultipleChoice5 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevelCavewithLightsMultipleChoice5;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Thaddeus").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Thaddeus").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevelCavewithLightsMultipleChoice5.SetActive (false);
