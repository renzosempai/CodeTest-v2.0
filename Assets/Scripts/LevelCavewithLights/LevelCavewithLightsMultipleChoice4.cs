...
public class LevelCavewithLightsMultipleChoice4 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevelCavewithLightsMultipleChoice4;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Pam").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Pam").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevelCavewithLightsMultipleChoice4.SetActive (false);
