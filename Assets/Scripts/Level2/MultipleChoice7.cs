...
public class MultipleChoice7 : MonoBehaviour {
...
//	}
	...
	public GameObject CallMultipleChoice7;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Marco").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Marco").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallMultipleChoice7.SetActive (false);
