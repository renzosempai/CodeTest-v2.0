...
public class Level2TrueOrFalse : MonoBehaviour {
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Ethan").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Ethan").GetComponent<InteractTrainer> ().busy = false;
