...
public class Level2TextQuiz : MonoBehaviour {
...
//		countGuess++;
	...
	public void Done(){
		...
		GameObject.Find ("Armstrong").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Armstrong").GetComponent<InteractTrainer> ().busy = false;
