...
public class MultipleChoice1 : MonoBehaviour {
...
//	}
	...
	public GameObject CallMultipleChoice1;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Nathaniel").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Nathaniel").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallMultipleChoice1.SetActive (false);
