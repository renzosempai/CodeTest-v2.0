...
public class MultipleChoice4 : MonoBehaviour {
...
//	}
	...
	public GameObject CallMultipleChoice4;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Ashe").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Ashe").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallMultipleChoice4.SetActive (false);
