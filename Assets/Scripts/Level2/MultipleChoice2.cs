...
public class MultipleChoice2 : MonoBehaviour {
...
//	}
	...
	public GameObject CallMultipleChoice2;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Audwin").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Audwin").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallMultipleChoice2.SetActive (false);
