...
public class MultipleChoice6 : MonoBehaviour {
...
//	}
	...
	public GameObject CallMultipleChoice6;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Jaina").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Jaina").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallMultipleChoice6.SetActive (false);
