...
public class MultipleChoice5 : MonoBehaviour {
...
//	}
	...
	public GameObject CallMultipleChoice5;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Freddie").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Freddie").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallMultipleChoice5.SetActive (false);
