...
public class MultipleChoice3 : MonoBehaviour {
...
//	}
	...
	public GameObject CallMultipleChoice3;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Gideon").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Gideon").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallMultipleChoice3.SetActive (false);
