...
public class Level4MultipleChoice6 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevel4MultipleChoice6;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Shannon").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Shannon").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevel4MultipleChoice6.SetActive (false);
