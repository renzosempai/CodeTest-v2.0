...
public class Level4TextQuiz : MonoBehaviour {

	public GameObject CallLevel4TextQuiz;
...
//		countGuess++;
	...
	public void Done(){
		...
		GameObject.Find ("Arthur").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Arthur").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevel4TextQuiz.SetActive (false);
