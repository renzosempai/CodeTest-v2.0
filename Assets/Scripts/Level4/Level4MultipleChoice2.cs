...
public class Level4MultipleChoice2 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevel4MultipleChoice2;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Constance").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Constance").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevel4MultipleChoice2.SetActive (false);
