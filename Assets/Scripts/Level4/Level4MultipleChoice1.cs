...
public class Level4MultipleChoice1 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevel4MultipleChoice1;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Heath").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Heath").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevel4MultipleChoice1.SetActive (false);
