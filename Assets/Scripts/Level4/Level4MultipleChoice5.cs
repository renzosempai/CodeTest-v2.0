...
public class Level4MultipleChoice5 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevel4MultipleChoice5;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Josef").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Josef").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevel4MultipleChoice5.SetActive (false);
