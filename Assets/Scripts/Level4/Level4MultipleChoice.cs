...
public class Level4MultipleChoice : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevel4MultipleChoice;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Pamela").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Pamela").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevel4MultipleChoice.SetActive (false);
