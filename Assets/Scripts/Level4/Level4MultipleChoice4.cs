...
public class Level4MultipleChoice4 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevel4MultipleChoice4;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Willa").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Willa").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevel4MultipleChoice4.SetActive (false);
