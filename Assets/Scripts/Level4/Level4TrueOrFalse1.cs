...
public class Level4TrueOrFalse1 : MonoBehaviour {

	List<string> questions = new List<string> () {" "};
	List<string> correctAnswer = new List<string>() {" "};
	public GameObject CallLevel4TrueOrFalse1;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Dwight").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Dwight").GetComponent<InteractTrainer> ().busy = false;
	/* 	StartCoroutine(BacktoWorld()); */
		CallLevel4TrueOrFalse1.SetActive (false);
