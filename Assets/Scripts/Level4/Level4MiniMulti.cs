...
public class Level4MiniMulti : MonoBehaviour {
	...
	public GameObject CallLevel4MiniMulti;
	...
	void Update () {
		...
		if (choiceSelected == "y") {
			...
			if (correctAnswer[randQuestion] != selectedAnswer) {
				...
				GameObject.Find ("Guess").GetComponent<Level4GuessTracker> ().guesscount--;
				//				StartCoroutine(Wait());
	...
	public void MiniDone(){
		...
		CallLevel4MiniMulti.SetActive (false);
