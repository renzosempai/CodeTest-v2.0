...
public class Level4MultipleChoice3 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevel4MultipleChoice3;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Joey").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Joey").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevel4MultipleChoice3.SetActive (false);
