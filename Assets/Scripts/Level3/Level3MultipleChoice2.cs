...
public class Level3MultipleChoice2 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevel3MultipleChoice2;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Emily").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Emily").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevel3MultipleChoice2.SetActive (false);
