...
public class Level3MultipleChoice7 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevel3MultipleChoice7;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Wildred").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Wildred").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevel3MultipleChoice7.SetActive (false);
