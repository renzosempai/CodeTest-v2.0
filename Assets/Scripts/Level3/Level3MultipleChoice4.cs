...
public class Level3MultipleChoice4 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevel3MultipleChoice4;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Dryden").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Dryden").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevel3MultipleChoice4.SetActive (false);
