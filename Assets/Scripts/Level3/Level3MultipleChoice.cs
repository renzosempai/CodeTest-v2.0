...
public class Level3MultipleChoice : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevel3MultipleChoice;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Garen").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Garen").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevel3MultipleChoice.SetActive (false);
