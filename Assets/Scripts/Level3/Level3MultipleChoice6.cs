...
public class Level3MultipleChoice6 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevel3MultipleChoice6;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Reiner").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Reiner").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevel3MultipleChoice6.SetActive (false);
