...
public class Level3MultipleChoice5 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevel3MultipleChoice5;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Christoph").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Christoph").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevel3MultipleChoice5.SetActive (false);
