...
public class Level3MultipleChoice3 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevel3MultipleChoice3;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Wanda").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Wanda").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevel3MultipleChoice3.SetActive (false);
