...
public class Level3MultipleChoice8 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevel3MultipleChoice8;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Abigail").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Abigail").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevel3MultipleChoice8.SetActive (false);
