...
public class LevelSpotLightsMultipleChoice6 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevelSpotLightsMultipleChoice6;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Dean").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Dean").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevelSpotLightsMultipleChoice6.SetActive (false);
