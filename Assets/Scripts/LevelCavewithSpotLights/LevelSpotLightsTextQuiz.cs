...
public class LevelSpotLightsTextQuiz : MonoBehaviour {

	public GameObject CallLevelSpotLightsTextQuiz;
...
//		countGuess++;
	...
	public void Done(){
		...
		GameObject.Find ("Angela").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Angela").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevelSpotLightsTextQuiz.SetActive (false);
