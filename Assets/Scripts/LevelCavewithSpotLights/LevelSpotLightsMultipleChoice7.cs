...
public class LevelSpotLightsMultipleChoice7 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevelSpotLightsMultipleChoice7;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Rowan").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Rowan").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevelSpotLightsMultipleChoice7.SetActive (false);
