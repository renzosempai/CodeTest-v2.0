...
public class LevelSpotLightsChoice : MonoBehaviour {
...
//		}
	...
	public void Answer(){
		...
		LevelSpotLightsMultipleChoice.selectedAnswer = gameObject.name;
		LevelSpotLightsMultipleChoice.choiceSelected = "y";
	}
