...
public class LevelSpotLightsMultipleChoice3 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevelSpotLightsMultipleChoice3;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Richard").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Richard").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevelSpotLightsMultipleChoice3.SetActive (false);
