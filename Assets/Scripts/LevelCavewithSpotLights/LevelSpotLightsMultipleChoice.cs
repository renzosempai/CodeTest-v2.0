...
public class LevelSpotLightsMultipleChoice : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevelSpotLightsMultipleChoice;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Jim").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Jim").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevelSpotLightsMultipleChoice.SetActive (false);
