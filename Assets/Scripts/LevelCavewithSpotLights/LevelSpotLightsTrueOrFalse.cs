...
public class LevelSpotLightsTrueOrFalse : MonoBehaviour {

	List<string> questions = new List<string> () {" "};
	List<string> correctAnswer = new List<string>() {" "};
	public GameObject CallLevelSpotLightsTrueOrFalse;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Pearce").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Pearce").GetComponent<InteractTrainer> ().busy = false;
	/* 	StartCoroutine(BacktoWorld()); */
		CallLevelSpotLightsTrueOrFalse.SetActive (false);
