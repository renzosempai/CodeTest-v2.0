...
public class LevelSpotLightsMultipleChoice5 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevelSpotLightsMultipleChoice5;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Kagura").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Kagura").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevelSpotLightsMultipleChoice5.SetActive (false);
