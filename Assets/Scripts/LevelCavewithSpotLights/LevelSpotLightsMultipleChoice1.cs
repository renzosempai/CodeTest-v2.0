...
public class LevelSpotLightsMultipleChoice1 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevelSpotLightsMultipleChoice1;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Kelly").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Kelly").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevelSpotLightsMultipleChoice1.SetActive (false);
