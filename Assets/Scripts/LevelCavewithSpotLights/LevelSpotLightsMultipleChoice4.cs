...
public class LevelSpotLightsMultipleChoice4 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevelSpotLightsMultipleChoice4;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Elliot").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Elliot").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevelSpotLightsMultipleChoice4.SetActive (false);
