...
public class LevelSpotLightsMultipleChoice2 : MonoBehaviour {
...
//	}
	...
	public GameObject CallLevelSpotLightsMultipleChoice2;
...
//			GetComponent<Text> ().text = questions [randQuestion];
	...
	public void Done(){
		...
		GameObject.Find ("Riria").GetComponent<InteractTrainer> ().defeated = true;
		GameObject.Find ("Riria").GetComponent<InteractTrainer> ().busy = false;
		/* StartCoroutine(BacktoWorld()); */
		CallLevelSpotLightsMultipleChoice2.SetActive (false);
